...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'nomUsuario',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'nomUsuario'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'apellUsuario'); ?>
		<?php echo $form->textField($model,'apellUsuario',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'apellUsuario'); ?>
	</div>
